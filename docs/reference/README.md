...
3. **Check planned work:** [`docs/IMPLEMENTATION_BACKLOG.md`](../IMPLEMENTATION_BACKLOG.md) is the single ordered living to-do list. For a quick **feature inventory** (what exists / gaps), see [language/feature_inventory.md](language/feature_inventory.md).
...
| Section | Role |
| -------- | ---- |
| [language/](language/README.md) | Quick syntax reference plus normative language rules by topic (declarations, types, expressions, statements, functions, built-ins). |
...
- **[`docs/IMPLEMENTATION_BACKLOG.md`](../IMPLEMENTATION_BACKLOG.md)** is the source of truth for implementation order, not current behavior.
