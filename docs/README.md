...
| [`reference/language/quick_reference.md`](reference/language/quick_reference.md) | Compact language syntax and built-in prototypes. |
...
| Path | Role |
|------|------|
| [`IMPLEMENTATION_BACKLOG.md`](IMPLEMENTATION_BACKLOG.md) | Single ordered living to-do list for near-term implementation work. |
...
| Path | Role |
|------|------|
| [`design/`](design/) | Design drafts and architecture notes. These are not the live spec or work queue; see `reference/` for current behavior and `IMPLEMENTATION_BACKLOG.md` for sequencing. |
